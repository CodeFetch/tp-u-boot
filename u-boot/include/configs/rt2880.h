...
#elif defined(DUAL_UBOOT_SUPPORT)
	#define CFG_BOOTLOADER_SIZE	FACTORY_UBOOT_SIZE
	#define CFG_SECONDLOADER_SIZE SECOND_UBOOT_SIZE
#else
	#define CFG_BOOTLOADER_SIZE	0x20000
#endif
...
#if defined(DUAL_UBOOT_SUPPORT)
#define CFG_SECLOADER_ADDR	(CFG_FLASH_BASE + CFG_BOOTLOADER_SIZE)
#define CFG_KERN_ADDR		(CFG_FLASH_BASE + (CFG_BOOTLOADER_SIZE + CFG_SECONDLOADER_SIZE + CFG_CONFIG_SIZE + CFG_FACTORY_SIZE))
#define CFG_BOOTARGS_ADDR	(CFG_FLASH_BASE + DUAL_UBOOT_ARGS_ADDR)
#else
...
#endif /* defined(MINI_WEB_SERVER_SUPPORT) */
